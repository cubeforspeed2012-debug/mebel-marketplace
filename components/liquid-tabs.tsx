      ...
      {items.map((item, index) => {
        ...
        return (
          <Link
            ...
            href={item.href}
            /*
             * Раньше здесь стояло prefetch — браузер заранее собирал все
             * соседние разделы. Выглядело быстро, но один клик по меню
             * поднимал на сервере полтора десятка страниц, и каждая заново
             * спрашивала у Supabase, кто вошёл. Бесплатный тариф от такого
             * напора замолкал, и вошедшего выкидывало на регистрацию.
             *
             * Капсула и так уезжает сразу по нажатию, не дожидаясь загрузки,
             * поэтому на глаз переход остался таким же быстрым.
             */
            prefetch={false}
