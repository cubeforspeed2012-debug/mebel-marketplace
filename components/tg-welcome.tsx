    ...
    <div className="px-4 py-7">
      ...
      {error === 'no-account' && (
        <div className="mt-6 rounded-2xl border border-[#b91c1c]/40 bg-[#b91c1c]/10 px-4 py-4 text-sm leading-relaxed text-status-error">
          <b>Этой почты у нас ещё нет.</b>
          <br />
          Здесь только вход — зарегистрироваться можно на сайте, там мастер
          заводит мастерскую с фото и районом. Или войдите другим аккаунтом
          Google: при нажатии он теперь спрашивает, каким именно.
        </div>
      )}
