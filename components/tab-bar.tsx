...
function IconHome(active: boolean) {
  return (
    <svg viewBox="0 0 24 24" className="size-[21px]" fill={active ? 'currentColor' : 'none'}
...
function IconCheck(active: boolean) {
  return (
    <svg viewBox="0 0 24 24" className="size-[21px]" fill="none" strokeWidth={active ? 2.6 : 2}
         stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
...
export function TabBar({
  ...
  const canAdd = (role === 'seller' || role === 'admin') && tabs.length <= 4
