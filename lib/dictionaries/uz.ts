...
export const uz: typeof ru = {
  ...
  product: {
    ...
    portfolio: 'Usta portfoliosi',
    worksCount: 'ta ish portfolioda',
    about: 'Usta haqida',
    disclaimer:
  ...
  auth: {
    ...
    termsRequired: 'Roʻyxatdan oʻtish uchun foydalanish shartlarini qabul qiling',
  ...
  reviews: {
    ...
    of5: '5 dan',
    labels: ['Yomon', "O'rtacha", 'Normal', 'Yaxshi', "A'lo"],
    placeholder: "Nima buyurtma qildingiz, qanday o'tdi, nima yoqdi — ixtiyoriy",
    send: 'Yuborish',
    update: 'Sharhni yangilash',
    signInToReview: 'Sharh qoldirish uchun kiring',
    ownCompany: "Bu sizning ustaxonangiz — sharhlarni xaridorlar qoldiradi",
  },

  about: {
    eyebrow: 'Toshkent mebel ustalari platformasi',
    titleStart: 'Buyurtmaga mebel —',
    titleMarker: "to'g'ridan-to'g'ri ustadan",
    lead: "Haqiqiy ishlarni ko'ring, narxlarni solishtiring va o'zi yasaydigan ustaga qo'ng'iroq qiling. Salonlar, vositachilar va ustamasiz.",
    ...
    buyerPoints: [
      "Katalog rasmlari emas, haqiqiy ishlar fotosi",
      "Ustaning narxi — salon ustamasisiz",
      "To'g'ridan-to'g'ri qo'ng'iroq qiling yoki so'rov qoldiring, usta qayta qo'ng'iroq qiladi",
    ],
    forMaster: 'Ustaga',
    masterTitle: "Mijozlar sizni izlamoqda — ishlaringizni ko'rsating",
    masterPoints: [
      "Portfolioli o'z sahifangiz — havolani mijozlarga yuboring",
    ...
    why: [
      ...
      { title: "So'rovlar Telegramda", text: "Mijoz so'rov qoldirdi — sizga xabar keldi. Telefondan javob berish mumkin." },
      { title: 'Halol raqamlar', text: "Ko'rishlar odamlar bo'yicha hisoblanadi, F5 bosishlar bo'yicha emas. Aldab bo'lmaydi." },
      { title: "O'z sahifangiz", text: "12 tagacha foto portfolio va mijozga yuborishga arzigulik havola." },
      { title: 'Sharhlar', text: "Mamnun mijozlar yulduz qo'yadi — keyingilari ishonch bilan keladi." },
      { title: 'Vositachisiz', text: "Biz bitimdan foiz olmaymiz. Mijoz bizga emas, sizga to'laydi." },
    ],
    ctaTitle: 'Bugun birinchi ishingizni joylashtiring',
    ctaText: "Ro'yxatdan o'tish bepul. Ustaxonani bir kunda tekshiramiz — va siz katalogdasiz.",
    ctaButton: "Usta bo'lish",
