      ...
      {isLogin ? (
        ...
        <form action={signUpAction} className="space-y-5">
          ...
          {/*
            ...
            Мелкая строчка «регистрируясь, вы соглашаетесь» юридически
            слабее: по ней не видно, что человек вообще её заметил.
            Ссылки открываются в новой вкладке, чтобы заполненная форма
            не потерялась, пока он читает условия.
          */}
          <label className="flex cursor-pointer items-start gap-3 rounded-2xl border border-line bg-cream p-4">
            <input
              type="checkbox"
              name="terms"
              required
